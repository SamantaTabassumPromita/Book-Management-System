...
$sql2 = "INSERT INTO offered (ISBN, std_id3, exISBN) VALUES('$_POST[isbn]','$user_Id','$_POST[isbnex]')";

$sql3 = "INSERT INTO exchange_with VALUES('$_POST[isbnex]','$user_Id','$_POST[Bnameex]','$_POST[editionex]','$_POST[Fauthorex]','0')";
...
<div class="container-fluid" align="center" style="padding-top:2%;">
  <!-- Material form login -->
  <div class="card mb-5">
    <div class="card-header mb-3 aqua-gradient white-text text-center py-4">
     <img class="mb-5" src="img/exchange.png" style="width: 8rem;" align="center"><br>
     <h2 style="font-weight: bold;">Exchange Book</h2>
   </div>
   ...
   <div class="card-body px-lg-5 pt-0">
    ...
    <h4 class="text-center primary-color text-white p-3"> Your offered book</h4>
    <div class="form-row ">
    ...
    <div class="col-md-8 mb-3 md-form" id="hidden_div" >
     <div class="form-row">
       <div class="col-md-4 mb-3">
         <select class="mdb-select" name="dept" selected="0">
...
<div class="form-row">
  <div class="col-md-5 mb-3 md-form">
    <input type="text" id="fauth"  name="Fauthor" class="form-control" required>
    <label for="fauth">First Author's Name</label>
    <div class="invalid-feedback">
  ...
  <div class="col-md-5 mb-3 md-form">
    <input type="text" id="sauth"  name="Sauthor" class="form-control">
    <label for="sauth">Second Author's Name(optional)</label>
  ...
  <div class="form-row">
    ...
    <div class="col-md-9 p-4 " align="left">
...
<h4 class="text-center success-color text-white p-3"> Exchange with </h4>
<div class="form-row">
  <div class="col-md-6 mb-3 md-form">
    <label for="validationCustom012">Book name</label>
    <input type="text" class="form-control" name="Bnameex" id="validationCustom012"  value=""
    required>

  </div>
  <div class="col-md-6 mb-3 md-form">
    <label for="validationCustom022">Book Edition</label>
    <input type="number" class="form-control" name="editionex" id="validationCustom022" min ="1" value="" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
...
<div class="form-row">
  <div class="col-md-6 mb-3 md-form">
    <label for="isb">ISBN-13 Number</label>
    <input type="text" class="form-control" id="isb" name="isbnex" pattern="[0-9]{13}" aria-describedby="inputGroupPrepend2"
    required>
    <div class="invalid-feedback">
      Please use Valid Input.if you are not aware with the ISBN then you can check online by the name of your Book!
    </div>
...
<div class="form-row">
  <div class="col-md-5 mb-3 md-form">
    <input type="text" id="validationCustom072"  name="Fauthorex" class="form-control" required>
