...
// Create connection
	...
	$ownID = $_SESSION['myid'];
	$sell = "UPDATE sell SET stat='3'WHERE req_id='$reqId' AND std_id1='$ownID'";
...
// Create connection
	...
	$reqId = $_SESSION['reqid'];
	$ownID = $_SESSION['myid'];
	$reject = "UPDATE sell SET stat='0', req_id='0' WHERE std_id1='$ownID' AND req_id='$reqId'";
...
// Create connection
    ...
    $dlt = "DELETE FROM sell WHERE ISBN='$pid' AND std_id1=$id";
...
// Create connection
				...
				while ($row = mysqli_fetch_assoc($result)) {
					...
					if ($row['stat']==0) {
						...
						<p>Email: ".$reqemail."</p>
						<p>Mobile: ".$reqmob."</p>
						<button class='btn btn-success' type='submit' name='acpt'>Aceept ?</button>
						<button class='btn btn-danger' type='submit' name='rjct'>Reject</button>
						</form>";
					}
					else{
						echo "<button class='btn btn-disabled'>sold</button>
						<button class='btn btn-danger' type='submit' name='dlt'>REMOVE</button>";
