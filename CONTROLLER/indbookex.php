...
// Create connection
	...
	$exisb = $_SESSION['exisbn'];
	$sql2 = "UPDATE exchange_with SET stat='1', req_id='$reqId' WHERE std_id5='$ownID' AND exISBN = '$exisb' AND std_id5 !='$reqId'";
...
// Create connection
				...
				while ($row = mysqli_fetch_assoc($result)) {
					...
					if ($row['stat']==0) {
						...
						<button class='btn btn-success' type='submit' name='req'>offer exchange</button>
						</form>";
					}
					else{
